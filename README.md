...
Στον κατάλογο ``/Κώδικας`` μπορείτε να βρείτε 

- τον κώδικα MATLAB για όλα τα παραδείγματα της 1ης έκδοσης του βιβλίου, καθώς και
- κώδικα Python για τη 2η έκδοση (ο κώδικας Python ΔΕΝ περιλαμβάνεται στην έντυπη 2η έκδοση).
